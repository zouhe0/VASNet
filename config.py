"""ZUP hyperparameter presets and DictBlock CSC configuration."""
import torch.nn as nn
import torch

# ---- DictBlock CSC config (matched to PanCSC-Net spirit) ----
CSC_CONFIG = {
    "MU": 0.0,
    "SQUARE_NOISE": True,
    "EXPANSION_FACTOR": 1,
...
# ---- Dataset presets (WV3/8ch full-resolution) ----
DATASET_PRESETS = {
    "WV3": {
        "sensor": "WV3",
...
TRAIN_DEFAULTS = {
    ...
    "w_spa": 200,
    "w_spec": 250,
    "w_var": 1_850_000.0,   # WV3 full: variance loss weight
    "lmbd_weight": 500.0,   # Phase2 lambda L2 regularization
    "temperature": 1.0,
    "ratio": 4,
    "seed": 10,
    "max_value": 2047.0,
...
# ---- Ablation presets (for discussion experiments) ----
ABLATION_PRESETS = {}
for t in [3, 5, 7]:
...
# ---- Lambda helpers (DictBlock sparse coding params) ----
